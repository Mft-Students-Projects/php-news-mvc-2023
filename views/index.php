    ...
    <div class="container main-container">
            ...
            <aside class="sidebar col-xl-2 col-lg-3 col-12 order-2 order-lg-1 pl-0 hidden-md">
                ...
                <div class="sidebar-inner dt-sl">
                    <div class="sidebar-banner">
                        <a href="#" target="_top">
                            <img src="./assets/client/img/banner/sidebar-banner-1.gif" width="100%" height="329"
                                 alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-xl-10 col-lg-9 col-12 order-1 order-lg-2">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/1.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/2.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/3.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/4.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/5.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/6.jpg)">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#"
                               style="background-image: url(./assets/client/img/main-slider/7.jpg)">
                            </a>
                        </div>
                    </div>
                ...
                <section id="main-slider-res"
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/1.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/2.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/3.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/4.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/5.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/client/img/main-slider/slider-responsive/6.jpg" alt=""
                                     class="img-fluid">
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 hidden-lg pr-0">
                <div class="widget-suggestion dt-sn border pt-3 mt-3">
                    <div class="widget-suggestion-title">
                        <img src="./assets/client/img/theme/suggestion-title.png" alt="">
                    </div>
                    <div id="progressBar">
        ...
        <div class="row mt-3 mb-5">
            <div class="col-sm-6 col-12 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/medium-banner-1.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-12 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/medium-banner-2.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3 mb-5">
            <div class="col-md-3 col-sm-6 col-6 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/small-banner-5.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/small-banner-6.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/small-banner-7.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-2">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/small-banner-8.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="category-slider owl-carousel">
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/notebook-computer.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/lifeline-in-a-heart-outline.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/repair-tools.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/hanbok.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/sofa.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/school-material.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/baby-girl.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/adventurer.png" alt="">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/client/img/category/restaurant-cutlery-circular-symbol-of-a-spoon-and-a-fork-in-a-circle.png"
                                         alt="">
        ...
        <div class="row mt-3 mb-5">
            <div class="col-12">
                <div class="widget-banner">
                    <a href="#">
                        <img src="./assets/client/img/banner/large-banner.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/017.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/020.jpg" alt="">
                                    </a>
                                </div>
                                <div class="card-horizontal-product-content">
                                    <div class="card-horizontal-product-title">
                        ...
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/014.jpg" alt="">
                                    </a>
                                </div>
                                <div class="card-horizontal-product-content">
                                    <div class="card-horizontal-product-title">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/016.jpg" alt="">
                                    </a>
                                </div>
                                <div class="card-horizontal-product-content">
                                    <div class="card-horizontal-product-title">
                        ...
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/018.jpg" alt="">
                                    </a>
                                </div>
                                <div class="card-horizontal-product-content">
                                    <div class="card-horizontal-product-title">
                        ...
                        <div class="col-12">
                            <div class="card-horizontal-product border-bottom rounded-0">
                                <div class="card-horizontal-product-thumb">
                                    <a href="#">
                                        <img src="./assets/client/img/products/015.jpg" alt="">
                                    </a>
                                </div>
                                <div class="card-horizontal-product-content">
                                    <div class="card-horizontal-product-title">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="brand-slider carousel-lg owl-carousel owl-theme">
                        <div class="item">
                            <img src="./assets/client/img/brand/1076.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/1078.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/1080.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/2315.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/1086.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/5189.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/1000006973.png" class="img-fluid" alt="">
                        </div>
                        <div class="item">
                            <img src="./assets/client/img/brand/1000014452.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
                <!-- End Product-Slider -->
