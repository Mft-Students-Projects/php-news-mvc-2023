                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form enctype="multipart/form-data" action="/dashboard/products/store" method="POST">
                                                <fieldset class="form-group">
                                                    <label for="name">نام محصول</label>
                                                    <input type="text" name="name" class="form-control" id="name" placeholder="نام محصول را وارد کنید">
                                                </fieldset>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" name="enname" class="form-control" id="enname" placeholder="نام محصول را وارد کنید">
                                                </fieldset>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" id="price" placeholder="قیمت محصول را وارد کنید">
                                                </fieldset>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" name="description" class="form-control" id="description" placeholder="توضیحات محصول را وارد کنید">
                                                </fieldset>
